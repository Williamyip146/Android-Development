...
import com.example.william.androidonlinequizapp.Model.QuestionScore;
import com.example.william.androidonlinequizapp.ViewHolder.ScoreDetailViewHolder;
...
public class ScoreDetail extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<QuestionScore,ScoreDetailViewHolder> adapater;
    ...
    private void loadScoreDetail(String viewUser) {
        adapater = new FirebaseRecyclerAdapter<QuestionScore, ScoreDetailViewHolder>(
                QuestionScore.class,
            ...
            protected void populateViewHolder(ScoreDetailViewHolder viewHolder, QuestionScore model, int position) {
                viewHolder.txt_name.setText(model.getCategeryName());
                viewHolder.txt_score.setText(model.getScore());
            }
        };
        adapater.notifyDataSetChanged();
        scoreList.setAdapter(adapater);
    }
}
